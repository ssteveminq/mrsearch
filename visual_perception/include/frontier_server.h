...
#include <visual_perception/GetFrontierAction.h>
#include <visual_perception/GetFrontierResult.h>
#include <visual_perception/GetFrontierFeedback.h>
//#include <visualization_msgs/Marker.h>
#include <visualization_msgs/Marker.h>
#include <visualization_msgs/MarkerArray.h>
...
public:
  /// constructor
  frontier_manager(std::string name);
  frontier_manager();
  /// destructor
...
private:
  ...
  //actionlib::SimpleActionServer<visual_perception::GetFrontierAction> as_;
  visual_perception::GetFrontierFeedback feedback_;
  visual_perception::GetFrontierResult result_;

  ros::Publisher camera_visible_region_pub;
  ros::Publisher human_target_pub;
  ros::Publisher frontier_posearray_pub;
