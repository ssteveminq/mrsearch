    ...
    robot_state_()
{
  ...
  camera_visible_region.info.height= 30; //30
  camera_visible_region.info.resolution=0.5;
  camera_visible_region.info.origin.position.x=-7.5; // -7.5
  camera_visible_region.info.origin.position.y=-7.5; //-7.5
...
void visible_manager::getCameraregion()
{
  ...
  camera_visible_region.info.origin.position.x=global_robot_x-7.5;//7.5
  camera_visible_region.info.origin.position.y=global_robot_y-7.5;//7.5
