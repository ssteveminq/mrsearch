...
// constructor
inspection_manager::inspection_manager(ros::NodeHandle nh, std::string pose_topic_="amcl_pose", std::string camera_frame_="spot/camera_link")
  : nh_(nh),
    robot_state_()
{
...
int main(int argc, char **argv)
{
  ...
  // create tracker node
  inspection_manager visible_region_node(nh, argv[1],argv[2]);
