    ...
    robot_state_()
{
  ...
  agent_map_sub=nh_.subscribe<nav_msgs::OccupancyGrid>("hsrb/fov_map",10,&inspection_manager::agent1_localmap_callback,this);
...
void inspection_manager::publish_inspection_poses()
{
   ...
   filtered_pose_array.header.frame_id = "map_en"; 
...
bool inspection_manager::checked_with_search_map(const geometry_msgs::Pose& input )
{
    ...
    pose_in.header.frame_id="map_en";
    pose_in.pose=input;
