...
startingPosition = {0:(-4,-0.5), 1:(-2.5,0.75), 2:(3, -1.0), 3:(3.5,1.5)}
targetPosition = {0: (3.5,-0.5), 1:(4,0.5),   2:(-3.5, -1.5), 3:(-3,1.5)}
...
tree_.write(actor_pkg_path+'/worlds/apartment_human.world', pretty_print=True, xml_declaration=True, encoding="utf-8")
