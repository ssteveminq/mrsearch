...
public:
    ...
    void generate_biased_polar_states_double(const int, const Eigen::Vector3d&, double, std::vector<Eigen::Vector3d>&);
    /**
     ...
     */
    bool check_collision(state_lattice_planner::ObstacleMap<int>&, const std::vector<Eigen::Vector3d>&);
    /**
