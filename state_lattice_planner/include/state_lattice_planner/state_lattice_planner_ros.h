...
public:
    ...
    void process(void);
    bool process(const geometry_msgs::PoseStamped& local_goal, bool is_finalgoal, const std::vector<double>& robot_pose, bool& replan, bool& updated,std::vector<Eigen::Vector3d>& local_trj);
    bool getlocalplan(const geometry_msgs::PoseStamped& local_goal, bool is_finalgoal, const std::vector<double>& robot_pose, bool& replan);
