...
void PublishLocation(
  ...
  if(publishiter>250){
      ...
      pose_msg_.pose.pose=pose_out.pose;
      ...
      //pose_msg_.pose.pose.orientation.x =q.x;
      //pose_msg_.pose.pose.orientation.y =q.y;
      //pose_msg_.pose.pose.orientation.z =q.z;
      //pose_msg_.pose.pose.orientation.w =q.w;
