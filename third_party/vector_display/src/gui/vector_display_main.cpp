...
#include "third_party/GuiKeyboardEvent.h"
#include "third_party/GuiMouseClickEvent.h"
#include "third_party/GuiMouseMoveEvent.h"
#include "third_party/LocalizationGuiCaptureSrv.h"
...
third_party::GuiMouseMoveEvent mouse_move_msg_;
third_party::GuiMouseClickEvent mouse_click_msg_;
third_party::GuiKeyboardEvent keyboard_events_msg_;
...
bool CaptureCallback(third_party::LocalizationGuiCaptureSrv::Request& req,
                     third_party::LocalizationGuiCaptureSrv::Response& res) {
...
int main(int argc, char *argv[]) {
  ...
  mouse_move_publisher_ =
      node_handle.advertise<third_party::GuiMouseMoveEvent>(
      "Cobot/VectorLocalization/GuiMouseMoveEvents", 1, false);
  mouse_click_publisher_ =
      node_handle.advertise<third_party::GuiMouseClickEvent>(
      "Cobot/VectorLocalization/GuiMouseClickEvents", 1, false);
  keyboard_events_publisher_ =
      node_handle.advertise<third_party::GuiKeyboardEvent>(
