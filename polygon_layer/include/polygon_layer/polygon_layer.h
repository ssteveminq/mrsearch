...
#include <search_service/SetPolygon.h>
...
private:
   ...
   */
  bool setPolygonCb(search_service::SetPolygon::Request &req,  // NOLINT (runtime/references)
    search_service::SetPolygon::Response &res);  // NOLINT (runtime/references)
