...
protected:
    ...
    /**
     * @visualize markers for blacklist by mk
     */
    //bool visualize_frontiers(std::vector<Frontier> _frontier_list);
...
private:
    ...
    //tf::TransformListener tf_listener_;  #old version (up to kinetic)
