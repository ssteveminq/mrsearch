...
public:
    ...
    void loc_cb(const nav_msgs::Odometry::ConstPtr& msg)
    {
      ...
      transformStamped.child_frame_id = "turtlebot/base_footprint";
...
int main(int argc, char *argv[])
{
  ...
  ros::Subscriber tb1_loc_sub = n.subscribe("/turtlebot/odom", 1000, &Listener::loc_cb, &listener);
  ros::Publisher tb1_pose_pub = n.advertise<geometry_msgs::PoseWithCovarianceStamped>("/turtlebot/pose", 1000);
