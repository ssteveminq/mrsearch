...
public:
  ...
  void executeCB(const search_service::FakeMultiSearchGoalConstPtr &goal)
  {
...
protected:
  ...
  float sum_, sum_sq_;
  search_service::FakeMultiSearchFeedback feedback_;
  search_service::FakeMultiSearchResult result_;
...
{
  ros::init(argc, argv, "fake_multisearch_action");
  ROS_INFO("node_info");
